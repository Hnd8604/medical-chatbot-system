...
__all__ = [
    "TOOL_FHIR_STATUS", "TOOL_GET_PATIENT", "TOOL_GET_RESOURCE",
    "TOOL_SEARCH_PATIENTS", "TOOL_GET_OBSERVATIONS",
    "TOOL_GET_ENCOUNTERS", "TOOL_GET_CONDITIONS", "TOOL_GET_MEDICATIONS",
    "TOOL_GET_ALL_OBSERVATIONS", "TOOL_GET_ALL_ENCOUNTERS",
    "TOOL_GET_ALL_CONDITIONS", "TOOL_GET_ALL_MEDICATIONS",
    "TOOL_UNSUPPORTED", "ALL_PATIENT_TOOL_TO_BASE",
    "FHIR_PROTECTED_TOOLS", "TOOL_TO_INTENT",

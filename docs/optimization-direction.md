...
- `docs/M-context-rolling-summary.md` — context compression: LLM rolling summary, trigger theo độ dài hội thoại, chạy song song với answer.
...
Trạng thái repo: **đã triển khai Rolling Summary** (một lệnh gọi LLM async thuần) trong
